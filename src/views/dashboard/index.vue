<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">{{ title }}好,{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ name }} | {{ $store.state.user.userInfo.companyName }} - {{ $store.state.user.userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="onQuit">加班离职</el-button>
    ...
    <!-- 离职弹层 -->
    <quit :show-dialog.sync="showDialog" />
  </div>
</template>
